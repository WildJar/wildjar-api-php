...
/**
 * BlockCallerFromCallRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildjar
 * @author   WildJar pty ltd
 ...
 */
class BlockCallerFromCallRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blockCallerFromCall_request';
    ...
    */
     ...
     * Sets cdr_id
     *
     * @param float $cdr_id The Call ID for the call whose caller will be blocked
     *
     * @return self
     */
