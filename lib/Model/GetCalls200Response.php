...
/**
 * GetCalls200Response Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class GetCalls200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCalls_200_response';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'data' => '\WildJar\ApiClient\Model\Call[]',
        'records_total' => 'float',
    ...
    */
     ...
     * Gets data
     *
     * @return \WildJar\ApiClient\Model\Call[]|null
     */
     ...
     * Sets data
     *
     * @param \WildJar\ApiClient\Model\Call[]|null $data data
     *
     * @return self
     */
