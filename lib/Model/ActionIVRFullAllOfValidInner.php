...
/**
 * ActionIVRFullAllOfValidInner Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class ActionIVRFullAllOfValidInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionIVRFull_allOf_valid_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Friendly name of the IVR menu option. Added to call log records for calls where this option was selected.
     *
     * @return self
     */
    ...
    public function setRemoteCode($remote_code)
    {
        ...
        if (!is_null($remote_code) && (mb_strlen($remote_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $remote_code when calling ActionIVRFullAllOfValidInner., must be smaller than or equal to 10.');
        }
