<?php
/**
 * ActionRobinFullAllOfOptionsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ActionRobinFullAllOfOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildjar
 * @author   WildJar pty ltd
 ...
 */
class ActionRobinFullAllOfOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionRobinFull_allOf_options_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param float|null $id The ID number for the round robin member.
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string $action The action type to route to in the call flow for this member of the round robin.
     *
     * @return self
     */
     ...
     * Sets action_id
     *
     * @param float $action_id The action ID to route to in the call flow for this member of the round robin.
     *
     * @return self
     */
