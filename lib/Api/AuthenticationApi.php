...
class AuthenticationApi
{
    ...
    {
        list($response) = $this->loginWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function loginAsync(string $contentType = self::contentTypes['login'][0])
    {
        return $this->loginAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function loginRequest(string $contentType = self::contentTypes['login'][0])
    {
