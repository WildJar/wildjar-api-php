<?php
/**
 * ActionLocationsMapUpdateAllOfMap
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ActionLocationsMapUpdateAllOfMap Class Doc Comment
 *
 * @category Class
 * @description The postcode and branch code association for branches to be overridden from the automatically allocated branch.
 * @package  Wildjar
 * @author   WildJar pty ltd
 * @link     https://wildjar.com
 * @implements \ArrayAccess<string, mixed>
 */
class ActionLocationsMapUpdateAllOfMap implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionLocationsMapUpdate_allOf_map';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['_0000']) && (mb_strlen($this->container['_0000']) > 6)) {
            $invalidProperties[] = "invalid value for '_0000', the character length must be smaller than or equal to 6.";
        }
