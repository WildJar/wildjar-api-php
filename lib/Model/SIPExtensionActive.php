...
/**
 * SIPExtensionActive Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class SIPExtensionActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SIPExtensionActive';
    ...
    */
    ...
    public function setUuid($uuid)
    {
        ...
        if ((mb_strlen($uuid) > 50)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling SIPExtensionActive., must be smaller than or equal to 50.');
        }
    ...
    public function setExtension($extension)
    {
        ...
        if ((mb_strlen($extension) > 3)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling SIPExtensionActive., must be smaller than or equal to 3.');
        }
     ...
     * Sets status
     *
     * @param string|null $status SIP extension status.
     *
     * @return self
     */
