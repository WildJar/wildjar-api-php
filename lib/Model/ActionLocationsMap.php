...
/**
 * ActionLocationsMap Class Doc Comment
 *
 * @category Class
 * @package  Wildjar
 * @author   WildJar pty ltd
 ...
 */
class ActionLocationsMap implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionLocationsMap';
    ...
    protected static $openAPITypes = [
        ...
        'iv_rdigits' => 'mixed',
        'iv_rattempts' => 'mixed',
        'map' => '\Wildjar\Model\ActionLocationsMapAllOfMap'
    ];
    ...
    */
     ...
     * Gets map
     *
     * @return \Wildjar\Model\ActionLocationsMapAllOfMap|null
     */
     ...
     * Sets map
     *
     * @param \Wildjar\Model\ActionLocationsMapAllOfMap|null $map map
     *
     * @return self
     */
