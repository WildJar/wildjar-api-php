...
/**
 * ActionIVRFullAllOfValid Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class ActionIVRFullAllOfValid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionIVRFull_allOf_valid';
    ...
    */
    ...
    public function setRemoteCode($remote_code)
    {
        ...
        if (!is_null($remote_code) && (mb_strlen($remote_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $remote_code when calling ActionIVRFullAllOfValid., must be smaller than or equal to 10.');
        }
