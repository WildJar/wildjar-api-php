...
/**
 * ActionRobinFullAllOfOptions Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class ActionRobinFullAllOfOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionRobinFull_allOf_options';
