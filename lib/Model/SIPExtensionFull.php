...
/**
 * SIPExtensionFull Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class SIPExtensionFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SIPExtensionFull';
    ...
    */
    ...
    public function setUuid($uuid)
    {
        ...
        if ((mb_strlen($uuid) > 50)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling SIPExtensionFull., must be smaller than or equal to 50.');
        }
    ...
    public function setExtension($extension)
    {
        ...
        if ((mb_strlen($extension) > 3)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling SIPExtensionFull., must be smaller than or equal to 3.');
        }
