...
/**
 * ActionTimeFullAllOfTimes Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class ActionTimeFullAllOfTimes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionTimeFull_allOf_times';
    ...
    */
    ...
    public function setOption($option)
    {
        ...
        if ((mb_strlen($option) > 20)) {
            throw new \InvalidArgumentException('invalid length for $option when calling ActionTimeFullAllOfTimes., must be smaller than or equal to 20.');
        }
    ...
    public function setFromTime($from_time)
    {
        ...
        if ((mb_strlen($from_time) > 5)) {
            throw new \InvalidArgumentException('invalid length for $from_time when calling ActionTimeFullAllOfTimes., must be smaller than or equal to 5.');
        }
    ...
    public function setToTime($to_time)
    {
        ...
        if ((mb_strlen($to_time) > 5)) {
            throw new \InvalidArgumentException('invalid length for $to_time when calling ActionTimeFullAllOfTimes., must be smaller than or equal to 5.');
        }
