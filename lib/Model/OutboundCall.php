...
class OutboundCall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets account
     *
     * @param mixed|null $account The account number the outbound call is in.
     *
     * @return self
     */
     ...
     * Sets area
     *
     * @param mixed|null $area The called number's area. For geo callers, the broad call charging area. For mobiles in Australia calling a 1300 or 1800 number, the region the mobile is calling from.
     *
     * @return self
     */
     ...
     * Sets caller_name
     *
     * @param mixed|null $caller_name The caller's username in WildJar.
     *
     * @return self
     */
     ...
     * Sets channel
     *
     * @param mixed|null $channel The outbound channel the call was made on.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param mixed|null $country 2 character country code of the called number (ie. AU, GB, NZ, US). Refer to [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) for more information.
     *
     * @return self
     */
     ...
     * Sets list
     *
     * @param mixed|null $list The campaign list the number was dialed from.
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param mixed|null $location The called number's location. For geo callers, this is the caller's phone exchange. For mobile callers, this is \"Mobile\".
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param mixed|null $network The called party's network type.
     *
     * @return self
     */
     ...
     * Sets sip
     *
     * @param mixed|null $sip The SIP extension of the outbound caller.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param mixed|null $state The state the called party number is located in. If the country is not divided by states, the 2 character country code is used.
     *
     * @return self
     */
