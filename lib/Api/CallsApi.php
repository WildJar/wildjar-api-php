...
class CallsApi
{
	 ...
	 * 
	 * @param RequestParams_CallsApi_getCallDetails|null $passParams
	 *
	...
	public function getCallDetails( $id, $passParams = null) {
		if ($passParams===null) $passParams = new RequestParams_CallsApi_getCallDetails();
		...
		switch($statusCode) {
			case 200:
				...
				return new OperationReturnCallsApi(
	 ...
	 * List Calls
	 * 
	 * @param RequestParams_CallsApi_getCalls|null $passParams
	 *
	 * @throws \WildJar\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
	 * @throws \InvalidArgumentException
	 * @return \WildJar\ApiClient\Model\GetCalls200Response|object
	 */
	public function getCalls( $passParams = null) {
		if ($passParams===null) $passParams = new RequestParams_CallsApi_getCalls();

		$request = $this->getCallsRequest( $passParams->account,  $passParams->date_from,  $passParams->date_to,  $passParams->duration_min,  $passParams->duration_max,  $passParams->first_time_caller,  $passParams->order,  $passParams->status,  $passParams->timezone,  $passParams->tracking_number,  $passParams->tracking_source );
	 ...
	 * @return \GuzzleHttp\Psr7\Request
	 */
	public function getCallsRequest($account = null, $date_from = null, $date_to = null, $duration_min = null, $duration_max = null, $first_time_caller = null, $order = null, $status = null, $timezone = null, $tracking_number = null, $tracking_source = null )
	{
	 ...
	 * 
	 * @param RequestParams_CallsApi_getOutboundCallDetails|null $passParams
	 *
	 * @throws \WildJar\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
	 * @throws \InvalidArgumentException
	...
	public function getOutboundCallDetails( $uuid, $passParams = null) {
		if ($passParams===null) $passParams = new RequestParams_CallsApi_getOutboundCallDetails();
	 ...
	 * List Outbound Calls
	 * 
	 * @param RequestParams_CallsApi_getOutboundCalls|null $passParams
	 *
	 * @throws \WildJar\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
	 * @throws \InvalidArgumentException
	...
	public function getOutboundCalls( $passParams = null) {
		if ($passParams===null) $passParams = new RequestParams_CallsApi_getOutboundCalls();

		$request = $this->getOutboundCallsRequest( $passParams->account,  $passParams->date_from,  $passParams->date_to,  $passParams->duration_min,  $passParams->duration_max,  $passParams->order,  $passParams->status,  $passParams->timezone,  $passParams->tracking_number );
	 ...
	 * @return \GuzzleHttp\Psr7\Request
	 */
	public function getOutboundCallsRequest($account = null, $date_from = null, $date_to = null, $duration_min = null, $duration_max = null, $order = null, $status = null, $timezone = null, $tracking_number = null )
	{
	 ...
	 * 
	 * @param RequestParams_CallsApi_updateCall|null $passParams
	 *
	 * @throws \WildJar\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
	 * @throws \InvalidArgumentException
	 * @return \WildJar\ApiClient\Model\GetCallDetails200Response|object
	...
	public function updateCall( $id, $call, $passParams = null) {
		if ($passParams===null) $passParams = new RequestParams_CallsApi_updateCall();
	...
	class RequestParams_CallsApi_getCallDetails {
		
	}
	
	
	class RequestParams_CallsApi_getCalls {
		...
		/** @var  string $order Sort the call log by the Call ID. To sort ascending, use order&#x3D;id and to sort descending, use order&#x3D;-id.  */
		public $order ;
	...
	class RequestParams_CallsApi_getOutboundCallDetails {
		
	}
	
	
	class RequestParams_CallsApi_getOutboundCalls {
		...
		/** @var  string $order Sort the call log by the outbound call UUID. To sort ascending, use order&#x3D;uuid and to sort descending, use order&#x3D;-uuid.  */
		public $order ;
	...
	class RequestParams_CallsApi_updateCall {
		
	}
	

class OperationReturnCallsApi {
	public $data;
