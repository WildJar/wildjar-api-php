...
/**
 * WebConfigurationAllOfAlias Class Doc Comment
 *
 * @category Class
 * @package  WildJar\ApiClient
 * @author   WildJar pty ltd
 ...
 */
class WebConfigurationAllOfAlias implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebConfiguration_allOf_alias';
    ...
    */
     ...
     * Sets domain
     *
     * @param string|null $domain The domain the tracking code will be placed on.
     *
     * @return self
     */
     ...
     * Sets access
     *
     * @param string|null $access If using multiple accounts on the same DNI, whether it is allowed.
     *
     * @return self
     */
     ...
     * Sets account_name
     *
     * @param string|null $account_name Name of the account the alias is associated with.
     *
     * @return self
     */
